                    ...
                    <div className="slds-grid slds-wrap slds-m-top--large">
                        ...
                        <div className="slds-col--padded slds-size--1-of-2 slds-medium-size--1-of-3 slds-m-top--medium">
                            <dl className="page-header--rec-home__detail-item">
                                ...
                                <dd>
                                    <Link to={`/packageversion/${this.props.license.package_version_id}`} className="slds-text-body--regular slds-truncate" title="">{this.props.license.version_name}</Link>
                                </dd>
                            </dl>
                        </div>
                        <div className="slds-col--padded slds-size--1-of-2 slds-medium-size--1-of-3 slds-m-top--medium">
                            <dl className="page-header--rec-home__detail-item">
                                ...
                                <dd>
                                    <Link to={`/packageversion/${this.props.license.package_version_id}`} className="slds-text-body--regular slds-truncate" title="">{this.props.license.version_number}</Link>
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div className="slds-col--padded slds-size--1-of-2 slds-medium-size--1-of-3 slds-m-top--medium">
                            <dl className="page-header--rec-home__detail-item">
                                ...
                                <dd>
                                    <p className="slds-text-body--regular slds-truncate" title="">{moment(this.props.license.expiration).format("ll")}</p>
                                </dd>
                            </dl>
                        </div>
