...
export default class extends React.Component {
    ...
    state = {view: "grid", sortOrder: sortage.getSortOrder(this.SORTAGE_KEY, "name", "asc"), licenses: [], itemCount: "..."};

    componentDidMount() {
        licenseService.requestAll(this.state.sortOrder).then(licenses=> this.setState({licenses, itemCount: licenses.length}));
    }
        ...
        return (
            <div>
                <HomeHeader type="licenses"
                            ...
                            sortOptions={[{value:"name", label:"Name"},{value:"status", label:"Status"},{value:"modified_date", label:"Modified Date"},{value:"packageversion", label:"Package Version"}]}
