...
export default class extends React.Component {
    ...
    render() {
        let columns = [
            ...
            {Header: "Scheduled Start Time", maxWidth: 200, id: "start_time", accessor: d => moment(d.start_time).format("YYYY-MM-DD [at] HH:mm:ss"), sortable: true, clickable: true},
            {Header: "When", id: "when", accessor: d => moment(d.start_time).fromNow(), clickable: true},
