            ...
            <div>
                <section className="slds-modal slds-fade-in-open slds-modal_prompt">
                    <div className="slds-modal__container">
                        ...
                        <div onClick={this.loginHandler} className="slds-text-link_reset menu slds-media slds-media_center slds-media_large slds-modal__content slds-p-around_medium">
                            <div className="slds-media__figure">
                                <img src={`/assets/icons/standard/process_120.png`} alt="Login required" onClick={this.loginHandler} style={{cursor: "pointer"}}/>
                            </div>
