...
function requestUpgrade(req, res, next) {
	push.upgradeOrgs([req.params.id], req.body.versions, req.body.scheduled_date, req.session.username, req.body.gus_reference, req.body.description, req.body.transid)
		.then((upgrade) => {
